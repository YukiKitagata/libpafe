...
int felica_read_multi(felica *f, int n, int *servicecode, int *mode, uint8 *addr, uint8 *data);
int felica_write_multi(felica *f, int n, int *servicecode, int *mode, uint8 *addr, uint8 *data);
