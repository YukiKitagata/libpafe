...
int felica_write(felica * f, int *n, felica_block_info *info, uint8 *data);
...
int felica_read_multi(felica *f, int n, uint8 *servicecode, uint8 *mode, uint8 *addr, uint8 *data);
int felica_write_multi(felica *f, int n, uint8 *servicecode, uint8 *mode, uint8 *addr, uint8 *data);
